    ...
    >
      <div className=" bg-gray-50">
        <div className="text-center">
          <div className="">
            <h1 className="mb-4" style={{ color: "pink" }}>
        ...
        <div className="container mx-auto px-4">
          <div className=" mx-auto text-center">
            <h2 className=" font-bold mt-4 mb-6" style={{ color: "pink" }}>
              Our Mission
            </h2>
            <p className="text-gray-600 text-lg leading-relaxed">
              We strive to create a vibrant, supportive community that connects
              alumni across generations, fostering professional growth,
              mentorship opportunities, and lasting friendships while advancing
              our institution's legacy of excellence.
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className=" mx-auto">
            <h2 className=" font-bold mb-3 mt-3" style={{ color: "pink" }}>
              Our History
            </h2>
            <div className="prose prose-lg text-gray-600">
              <p className="mb-4">
                Founded in 1973, our Alumni Association has grown from a small
                group of dedicated graduates to a global network of
                professionals spanning various industries and continents.
              </p>
              <p className="mb-4">
                Over the decades, we've established numerous programs and
                initiatives to support our alumni community, including
                mentorship programs, networking events, and professional
        ...
        <div className="bg-gray-100 py-12">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold mb-8 " style={{ color: "pink" }}>
              Our Values
            </h2>
