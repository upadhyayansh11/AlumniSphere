...
export default function Hero() {
  return (
    <div
      className="container-fluid p-5 mb-1 bg-cover bg-center h-screen mt-5"
      style={{
        backgroundImage: `url('media/images/news.jpg')`,
        backgroundRepeat: "no-repeat",
      }}
    >
      <div className="flex flex-col justify-center items-center text-center text-pink-300 mt-20">
        <h1 className="mt-5 text-4xl md:text-5xl" style={{ color: "pink" }}>
          Reunion Homecoming and All Alumni Day
        </h1>
        <p className="text-white mt-4 px-4 md:px-0 max-w-2xl">
          Join the University alumni community this October for an unforgettable
          Alumni Reunion Weekend! Whether you’re a recent grad or long-time
          alum, come back to campus to reconnect with friends, dive into
          exciting events, and celebrate the legacy we all share. Rediscover the
        ...
        <div className="flex flex-col md:flex-row justify-center mt-10 space-y-10 md:space-y-0 md:space-x-10">
          <div className="bg-opacity-50 p-5 bg-black rounded-lg shadow-lg w-full md:w-1/2">
            <h1 className="text-2xl mb-2" style={{ color: "pink" }}>
              Reunion Time, ’4s and ’9s
            </h1>
            <h2 className="text-xl">December 24–27, 2024</h2>
            <p className="text-white mt-2">
              Reconnect with undergrad classmates over four unforgettable days
              packed with Mini-Reunions, your class party and tailgate, and
              Classes Without Quizzes—plus connect with Stanford friends who
              have your heart (but not your class year) at the new Farm Fest!
            </p>
            <a href="/" className="text-black underline mt-4 flex items-center">
              <b>Register for Reunion</b>
              <i
                className="fa fa-long-arrow-right m-1 text-red-600"
                aria-hidden="true"
              ></i>
            </a>
          </div>
          ...
          <div className="bg-opacity-50 p-5 bg-black rounded-lg shadow-lg w-full md:w-1/2">
            <h1 className="text-2xl mb-2" style={{ color: "pink" }}>
              Calling All Degrees and Years
            </h1>
            <h2 className="text-xl">December 31, 2024</h2>
            <p className="text-white mt-2">
              Discover the all-new All Alumni Day, featuring faculty lightning
              talks, campus tours, an all-years tailgate, and Farm Fest: a
              lively outdoor celebration with department and community pop-ups,
              food and drinks, live music, games, and more.
            </p>
            <a href="/" className="text-black underline mt-4 flex items-center">
              <b>Purchase a Pass</b>
              <i
                className="fa fa-long-arrow-right text-red-600"
                aria-hidden="true"
              ></i>
            </a>
          </div>
